...
function buildReport({ profile, anchors, schools, baseline, planStatus, latestCheck, expertRules, candidateEvaluation, riskFactors, parentActionPlan, biomedTransition, courseAudit, outcomeAudit, planAdmit }) {
  ...
  const focusJudgement = new Map([
    ...
    ["hitwh", "哈工大威海是第三优先级，但带卓越优才字样的项目本版先屏蔽；重点任务是向招生办确认2026陕西普通批可报专业、校区安排、毕业证、转专业、保研就业和学费。"],
    ["hitsz", "哈工大深圳作为补充观察，但当前贴线线索主要来自卓越优才计划；本版先从普通类主方案屏蔽，只有招生办确认2026陕西普通批可报后再作为高风险冲刺单独加回。"]
  ]);
  ...
  <main class="wrap">
    ...
    <section>
      ...
      <ul>
        ...
        <li>第三优先：哈工大威海。先屏蔽卓越优才字样条目，优先向招生办确认2026陕西普通批可报专业，再比较非特殊类型的机器人、AI、智能制造、软件等方向。</li>
        <li>补充观察：哈工大深圳。当前贴线线索主要来自卓越优才计划，本版先从普通类主方案屏蔽；若招生办明确2026陕西普通批可报，再作为高风险冲刺单独加回。</li>
